...
<%--顶部按钮和高级查询--%>
    <div id="SDUS_BTN">
        ...
        <div>
            ...
            <a class="easyui-linkbutton" href="/memberTop"  id="topBtn" iconCls="icon-reload" style="float:right;margin-right: 60px">充值记录</a>
        </div>
    </div>
    <%--增加会员--%>
        ...
        <form method="post" id="petInfo_addMember_form">
            ...
            <div align="left" style="margin-top: 10px">
                ...
                <div>
                    ...
                    <select class="easyui-combobox" name="vipClass.id" data-options="
                    width:150,
                valueField:'id',
                textField:'level',
                ...
                <div>
                    ...
                    <label><input name="gender" type="radio" value="" />不祥 </label>
                    <input class="easyui-textbox" name="birthday" data-options="label:'生日:'">
                ...
                <div>
                    ...
                    <input class="easyui-textbox" name="petBirthday" data-options="label:'宠物生日:'">
                    宠物性别:
                    <label><input name="petGender" type="radio" value="" />公 </label>
                    <label><input name="petGender" type="radio" value="" />母 </label>
                    <label><input name="petGender" type="radio" value="" />阉割版 </label>
        ...
        <form method="post" id="petInfo_addPet_form">
            ...
            <div align="left" style="margin-top: 10px">
                ...
                <div>
                    ...
                    <label><input name="petGender" type="radio" value="" />公</label>
                    <label><input name="petGender" type="radio" value="" />母</label>
                    <label><input name="petGender" type="radio" value="" />不详</label>
                </div>
                <div>
        ...
        <form method="post" id="petInfo_addMoney_form">
            ...
            <div align="left" style="margin-top: 10px">
                ...
                <div>
                    ...
                    卡内余额: <spen name="balances" id="moneyDalance" style="color: red"></spen>
                    历史消费总额:xxx元
                </div>
                <div>
                ...
                <div>
                    <input class="easyui-textbox" name="topremark" data-options="multiline:true,label:'备注:', height:70,width:250"/>
    ...
    <div id="member_addremark_dialog">
        ...
        <form method="post" id="petInfo_addremark_form">
            ...
            <div align="left" style="margin-top: 10px">
                <div>
                    该会员共消费: <span id="consumeID" name="consume"></span>元,
