...
<script type="text/javascript" src="/static/js/views/productScale.js"></script>
</head>
<body>
	...
	<div id="table_datagrid_tb">
		<table>
			<tr>
				<td><a class="easyui-linkbutton" data-options="text:'添加规格信息',onClick:myAdd"></a><td>
				<td><a class="easyui-linkbutton" data-options="text:'是否启用',onClick:myDelete"></a><td>
				<td><input class="easyui-textbox" data-options="buttonText:'查询',onClickButton:mySearch,prompt:'规格名称'"><td>
			</tr>
		</table>
	</div>
	<div id="div_dialog">
			...
			<table>
				<tr>
					<td><input class="easyui-textbox"  name="name"
							data-options="prompt:'请输入规格信息'"></td>
				</tr>
				<tr>
					<td>
