...
<script type="text/javascript" src="/static/js/views/memberLevel.js"></script>
</head>
<body>
	...
	<div id="table_datagrid_tb">
		<table>
			<tr>
				<td><a class="easyui-linkbutton" data-options="text:'添加会员等级',onClick:myAdd"></a><td>
				<td><a class="easyui-linkbutton" data-options="text:'是否启用',onClick:myDelete"></a><td>
				<td><input class="easyui-textbox" data-options="buttonText:'查询',onClickButton:mySearch,prompt:'会员等级名称'"><td>
			</tr>
		</table>
	</div>
	<div id="div_dialog">
			...
			<table>
				<tr>
					<td><input class="easyui-textbox"  name="level"
							data-options="prompt:'请输入会员等级信息'"/></td>
				</tr>
				<tr>
					<td>
						<input class="easyui-textbox"  name="serviceDiscount"
							data-options="prompt:'请输入会员服务折扣'"/>
					</td>
				</tr>
				<tr>
					<td>
						<input class="easyui-textbox"  name="productDiscount"
							data-options="prompt:'请输入会员商品折扣'"/>
					</td>
				</tr>
				<tr>
					<td>
